    ...
    public partial class Form1 : Form
    {
        ...
        ~Form1()
        {
            try
            {
                if (pozamiatane == false)
                {
                    ...
                    firewallController.CleanUpRules();
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            while (running)
            {
                ...
                {
                    Sprawdzacz.Aktualizuj_Pierwotna_Liste_Dyskow();
                } else if (cmd[0] == "DSTART")
                {
                    Sprawdzacz.sprawdzanie = true;
                } else if (cmd[0] == "DSTOP")
                {
                    Sprawdzacz.sprawdzanie = false;
                }
                else if (cmd[0] == "DSTARTG") {
                    Sprawdzacz.sprawdzanieG = true;
                } else if(cmd[0] == "DSTOPG")
                {
                    Sprawdzacz.sprawdzanieG = false;
                }
                ...
                {
                    this.SetText("Unknown command recived" + dane);
                }
            }
        }
        ...
        private void connectToServer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Monitor_Dysku.Monitor_Dysku.adresLokalny = adresLokalnyIP;
                ...
                Watek_Monitorowania_Dykow = new Thread(new ThreadStart(Sprawdzacz.Sprawdzanie));
