...
namespace Monitor_Dysku
{
        public class Monitor_Dysku
        {
            ...
            public static string adresLokalny;

            bool dzialanie = true;

            public bool sprawdzanie = false;
            public bool sprawdzanieG = false;
                ...
                while(dzialanie)
                {
                    while (sprawdzanie || dzialanie)
                    {
                        ...
                        if (zmieniono_liste_dyskow)
                        {
                            ...
                            //////////////////////////////////////// Do Zmiany 
                            WyslijWiadomoscUDP("NAR:" + adresLokalny + ":DS:");
