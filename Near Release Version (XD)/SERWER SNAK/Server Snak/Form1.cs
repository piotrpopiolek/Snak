...
namespace Server_Snak
{
    public partial class Form1 : Form
    {
        ...
        private bool pozamiatane = false;
        ...
        ~Form1()
        {
            if (pozamiatane == false)
            {
                running = false;

                wyslijWyadomoscDoKlientowWszystkich("BYE:");
        ...
        private void RemoveTextAll()
        {
            listBoxClient2.Invoke(new Action(delegate ()
            {
                listBoxClient2.Items.Clear();
            }));
            listBoxClient3.Invoke(new Action(delegate ()
            {
                listBoxClient3.Items.Clear();
            }));
            listBoxClient4.Invoke(new Action(delegate ()
            {
                listBoxClient4.Items.Clear();
            }));
            listBoxClient5.Invoke(new Action(delegate ()
            {
                listBoxClient5.Items.Clear();
            }));
        }
        ...
        private void buttonAddProcesToList_Click(object sender, EventArgs e)
        {
            try
            {
                if (textBoxAddProcesToList.Text == "") return;
        ...
        private void buttonAddDomenToList_Click(object sender, EventArgs e)
        {
            try
            {
                if (textBoxAddDomenToList.Text == "") return;
        ...
        private void listBoxClient2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            } else
            {
                ...
                // Zmiana listboxa4 na to samo co ma 2
                ...
                // Zmiana listboxa5 na to samo co ma 2
                if (listBoxClient2.SelectedIndex != listBoxClient5.SelectedIndex)
                {
                    listBoxClient5.Invoke(new Action(delegate ()
                    {
                        listBoxClient5.SelectedIndex = listBoxClient2.SelectedIndex;
                    }));

                    isChainedCall = false;
                }

                if (isChainedCall == false)
                {
                    updateBannedListboxes();
                }
            }
        ...
        void updateBannedListboxesOne()
        {
            ...
            checkBox5.Invoke(new Action(delegate ()
            {
                checkBox5.Checked = listaKlientow.zwrocCzySprawdzaDyski(clientName);
            }));
        ...
        void updateBannedListoxesALL()
        {
            ...
            checkBox5.Invoke(new Action(delegate ()
            {
                checkBox5.Checked = zabronioneDlaWszystkich.sprawdzanieDyskow;
            }));
        ...
        private void listBoxClient3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (listBoxClient3.SelectedIndex != listBoxClient2.SelectedIndex)
                {
                    listBoxClient2.Invoke(new Action(delegate ()
                    {
                ...
                if (listBoxClient3.SelectedIndex != listBoxClient5.SelectedIndex)
                {
                    listBoxClient5.Invoke(new Action(delegate ()
                    {
                        listBoxClient5.SelectedIndex = listBoxClient3.SelectedIndex;
                    }));
                    isChainedCall = false;
                }
                if (isChainedCall == false)
        ...
        private void listBoxClient4_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (listBoxClient4.SelectedIndex != listBoxClient2.SelectedIndex)
                {
                    listBoxClient2.Invoke(new Action(delegate ()
                    {
                ...
                if (listBoxClient4.SelectedIndex != listBoxClient3.SelectedIndex)
                {
                    listBoxClient3.Invoke(new Action(delegate ()
                    {
                ...
                if (listBoxClient4.SelectedIndex != listBoxClient5.SelectedIndex)
                {
                    listBoxClient5.Invoke(new Action(delegate ()
                    {
                        listBoxClient5.SelectedIndex = listBoxClient4.SelectedIndex;
                    }));
                    isChainedCall = false;
                }
                if (isChainedCall == false)
        ...
        private void listBoxClient5_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (checkBox1.Checked == true)
            {
                listBoxClient5.Invoke(new Action(delegate ()
                {
                    listBoxClient5.SelectedIndex = -1;
                }));
            ...
            {
                if (listBoxClient5.SelectedIndex == -1) { return; }
                ...
                if (listBoxClient2.SelectedIndex != listBoxClient5.SelectedIndex)
                {
                    listBoxClient2.Invoke(new Action(delegate ()
                    {
                        listBoxClient2.SelectedIndex = listBoxClient5.SelectedIndex;
                    }));
                    isChainedCall = false;
                }
                ...
                if (listBoxClient3.SelectedIndex != listBoxClient5.SelectedIndex)
                {
                    listBoxClient3.Invoke(new Action(delegate ()
                    {
                        listBoxClient3.SelectedIndex = listBoxClient5.SelectedIndex;
                    }));
                    isChainedCall = false;
                }
                ...
                if (listBoxClient4.SelectedIndex != listBoxClient5.SelectedIndex)
                {
                    listBoxClient4.Invoke(new Action(delegate ()
                    {
                        listBoxClient4.SelectedIndex = listBoxClient5.SelectedIndex;
                    }));
                    isChainedCall = false;
                }
                if (isChainedCall == false)
        ...
        void wyslijWyadomoscDoKlientowWszystkich(string command)
        {
            foreach (string item in listBoxClient2.Items)
            {
                string address = listaKlientow.NazwaDoIP(item);
        ...
        void wyslijWiadomoscDoKlientow(string command)
        {
            try
            {
                if (checkBox2.Checked == true)
        ...
        {
            wyslijWiadomoscDoKlientow("AKD:");
        }

        private void button2_Click(object sender, EventArgs e)
        {
            wyslijWiadomoscDoKlientow("BYE:");
            if (checkBox4.Checked)
            {
                // usun wszystkich
                listaKlientow.UsunWszystkichKlientow();
                RemoveTextAll();
            } else
            {
                // usun jednego
                ...
                {
                    if (listBoxClient2.SelectedIndex == -1) return;
                    string clientName = listBoxClient2.SelectedItem.ToString();

                    string clientIP = listaKlientow.NazwaDoIP(clientName);
                    listaKlientow.UsunKlienta(clientIP);

                    this.RemoveText(listBoxClient2.SelectedIndex);
                }));
        ...
        private void checkBox5_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox1.Checked)
            {
                ...
                {
                    if (zabronioneDlaWszystkich.sprawdzanieDyskow == false)
                    {
                        zabronioneDlaWszystkich.sprawdzanieDyskow = true;
                        wyslijWyadomoscDoKlientowWszystkich("DSTARTG");
                    }
                } else
                {
                    if (zabronioneDlaWszystkich.sprawdzanieDyskow == true)
                    {
                        zabronioneDlaWszystkich.sprawdzanieDyskow = false;
                        wyslijWyadomoscDoKlientowWszystkich("DSTOPG");
                    }
                }
            } else
            {
                ...
                {
                    if (listBoxClient5.SelectedIndex == -1) return;
                    string clientName = listBoxClient5.SelectedItem.ToString();

                    if (checkBox5.Checked)
                    {
                        if (listaKlientow.zwrocCzySprawdzaDyski(clientName) == false)
                        {
                            listaKlientow.ustawCzySprawdzaDyski(clientName, true);
                            wyslijWiadomoscDoKlientow("DSTART");
                        }
                    } else
                    {
                        if (listaKlientow.zwrocCzySprawdzaDyski(clientName) == true)
                        {
                            listaKlientow.ustawCzySprawdzaDyski(clientName, false);
                            wyslijWiadomoscDoKlientow("DSTOP");
                        }
                    }
                }));
            }
